...
}';    	//(REQUIRED) Your formatted source code for which you want to use hackerEarth api, leave this empty if you are using file
$config['input']='1 2  5 6 7 8 0 0';     	//(OPTIONAL) formatted input against which you have to test your source code
