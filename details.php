...
echo("Problem Name: $r1[pbname]<br><br> Problem ID: $r1[pbid]<br><br> Problem Details<br><br><textarea class=\"form-control\" rows=\"30\" cols=\"95\" readonly>$r1[pbdes]</textarea><br><br>Problem Setter: $r1[pbauthor]<br><br>");
...
if(isset($_GET['name']))
{
  ...
  $q3="SELECT * FROM element WHERE pbname='$des'";
